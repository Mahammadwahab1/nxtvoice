...
export class GdmLiveAudioVisuals extends LitElement {
  ...
  protected firstUpdated() {
    // FIX: Use `this.renderRoot` to query for the canvas element. This is the idiomatic Lit approach and avoids potential TypeScript type issues with `shadowRoot`.
